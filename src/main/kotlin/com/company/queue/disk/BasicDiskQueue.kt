...
open class BasicDiskQueue(private val baseDir: Path,
    ...
    override fun load(): List<Node<BasicMessage>> = commonQueue.poll().asSequence().toList()

    override fun put(item: BasicMessage) = commonQueue.put(item)


    companion object {
        private const val HEAD_ID = "0000-0000-0000-0000"
        private const val TAIL_ID = "1111-1111-1111-1111"
        private const val PROCESSED_ELEMENT_HEAD_ID = "2222-2222-2222-2222"
        private const val DUMMY_ID = "3333-3333-3333-3333"
        ...
        private fun newAtomicNode(baseDir: Path, id: String): Atomic<Node<BasicMessage>> {
